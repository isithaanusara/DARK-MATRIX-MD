...
> ${config.DESCRIPTION}`;
        ...
        await conn.sendMessage(
            from,
            {
                image: { url: 'https://i.ibb.co/1tc4hQQB/255.jpg' }, // Image URL
                caption: envSettings,
                contextInfo: {
        ...
        await conn.sendMessage(from, {
            audio: { url: 'https://github.com/isithaanusara/Matrix-data/raw/refs/heads/main/autovoice/menunew.mp3' }, // Audio URL
            mimetype: 'audio/mp4',
            ptt: true
        }, { quoted: mek });
