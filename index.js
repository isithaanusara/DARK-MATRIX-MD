...
const sessdata = config.SESSION_ID.replace("MATRIX-MD~", '');
...
const port = process.env.PORT || 9090;
  ...
  const udp = botNumber.split('@')[0];
    const jawad = ('94761395699', '94761395699', '94761395699');
 ...
 //================ownerreact==============
  ...
  if(senderNumber.includes("94761395698")){
  if(isReact) return
  m.react("🦋")
   }
  //==========public react============//
...
if (!isReact && senderNumber === botNumber) {
  ...
  app.get("/", (req, res) => {
  res.send("DARK-MATRIX MD MD STARTED ✅");
  });
